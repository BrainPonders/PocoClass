...
def test_filename_metadata_separation():
    ...
    test_cases = [
        {
            'name': 'ExampleBank Check Account - Pattern Match',
            'rule_id': 'examplebank_check_592',
        ...
        {
            'name': 'ExampleBank Check Account - No Pattern Match',
            'rule_id': 'examplebank_check_592', 
        ...
        {
            'name': 'ExampleBank Year Statement - Multiple Patterns',
            'rule_id': 'examplebank_year_statement',
...
def demonstrate_pattern_flexibility():
    ...
    rule_file = Path("rules/examplebank_year_statement.yaml")
    ...
    test_filenames = [
        ...
        "ExampleBank_Year_Statement_2024_NL89RABO592", 
