    ...
    for endpoint in endpoints:
        try:
            ...
            if response.status_code == 200:
                ...
                if 'rabobank' in content.lower() or 'rabo' in content.lower():
...
if __name__ == '__main__':
    ...
    if content:
        ...
        # Look for Rabobank patterns
        if 'rabobank' in content.lower():
            print("✓ Content contains Rabobank text")
        else:
            print("✗ Content does not contain Rabobank text")