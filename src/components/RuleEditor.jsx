              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2 opacity-40">
                  ...
                  <div className="flex-1">
                    ...
                    <input type="text" placeholder="1. ExampleBank Check Account" disabled className="w-full text-xs rounded px-2 py-1" style={{backgroundColor: 'var(--paperless-surface-light)', color: 'var(--paperless-text-secondary)', border: '1px solid var(--paperless-border)'}} />
                  </div>
                </div>
