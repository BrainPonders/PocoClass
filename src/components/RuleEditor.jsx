              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start gap-3 py-2 opacity-40">
                  ...
                  <div className="flex-1">
                    ...
                    <input type="text" placeholder="1. ExampleBank Check Account" disabled className="w-full text-sm rounded px-3 py-2" style={{backgroundColor: 'var(--paperless-surface-light)', color: 'var(--paperless-text-secondary)', border: '1px solid var(--paperless-border)'}} />
                  </div>
                </div>
