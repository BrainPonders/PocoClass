...
- `${HOME}/pococlass-dev/docker-compose.dev.yml`
- `${HOME}/pococlass-dev/.env`
- `${HOME}/pococlass-dev/data/`
- `${HOME}/pococlass-dev/rules/`
...
4. Ensures `${HOME}/pococlass-dev/` exists (or `POCOCLASS_DEV_ROOT` if set).
...
- Overwrite runtime `docker-compose.dev.yml`.
