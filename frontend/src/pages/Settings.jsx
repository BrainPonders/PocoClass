              ...
              {activeTab === 'system' && (
                <div className="space-y-8">
                  ...
                  <div className="border-t pt-6">
                    ...
                    {/* POCO Fields Warning */}
                    {syncStatus?.poco_fields?.checked && 
                     (!syncStatus.poco_fields.poco_score_exists || !syncStatus.poco_fields.poco_ocr_exists) && (
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-red-700 mb-2">
                              The following required custom fields are missing from your Paperless instance:
                            </p>
                            <ul className="list-disc list-inside text-sm text-red-700 mb-3">
                              {!syncStatus.poco_fields.poco_score_exists && (
                                <li><strong>POCO Score</strong> (integer field)</li>
                              )}
                              {!syncStatus.poco_fields.poco_ocr_exists && (
                                <li><strong>POCO OCR</strong> (integer field)</li>
                              )}
                            </ul>
                            <p className="text-sm text-red-700">
                              These fields are required for document classification. Please create them manually in your Paperless-ngx instance 
                              (Settings → Custom Fields) or re-run the initial setup.
                            </p>
                          </div>
                        </div>
                      </div>
